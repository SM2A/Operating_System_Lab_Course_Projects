...
extern int sys_set_hrrn_priority(void);
extern int sys_set_ptable_hrrn_priority(void);
...
[SYS_set_hrrn_priority] sys_set_hrrn_priority,
[SYS_set_ptable_hrrn_priority] sys_set_ptable_hrrn_priority,
